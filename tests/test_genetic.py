...
class TestGeneticConfig:
    def test_defaults(self) -> None:
        from cipher.genetic import GeneticConfig
...
class TestGeneticResult:
    def test_defaults(self) -> None:
        from cipher.genetic import GeneticResult
...
class TestGeneticHelpers:
    ...
    def test_mutate_preserves_permutation(self) -> None:
        from cipher.genetic import _mutate
    ...
    def test_decode_identity(self) -> None:
        from cipher.genetic import _decode
    ...
    def test_idx_to_text(self) -> None:
        from cipher.genetic import _idx_to_text
